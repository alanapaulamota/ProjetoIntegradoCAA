...
public class DicionarioHelpController {

	@Autowired
	DicionarioHelpService dicServico;
	...
	public String showHelpQuestionPage(ModelMap model) { // Model é um auxiliar que ajuda a adicionar atributos a nossa
															// view,
